...
<%
out.println("<br><h3>평가하기</h3>");
	session.setAttribute("selected_movie_id", Integer.parseInt(request.getParameter("id")));
	
	
	out.println("<form method=\"post\" action=\"../func/InsertRating.jsp\">");
    out.println("평점 : <input type=\"text\" class=\"form-control\" placeholder=\"평점(1~10점)\" name=\"point\" maxlength=\"2\"><br>");
    out.println("후기 : <input type=\"text\" class=\"form-control\" placeholder=\"코멘트\" style=\"width:300px;height:100px;\" name=\"comment\" maxlength=\"100\"><br>");
	out.println("<br><input type=\"submit\" class=\"btn btn-primary form-control\" value=\"평가하기\"></form>");
%>
